...
awful.screen.connect_for_each_screen(function(s)
	...
	s.network = require("ui.widgets.network")()
        s.hackthebox1 = require("ui.widgets.hackthebox1")
        s.hackthebox2 = require("ui.widgets.htb2")
        s.hackthebox3 = require("ui.widgets.hackdbox3")
        s.hackthebox4 = require("ui.widgets.hackeodecajas4")
